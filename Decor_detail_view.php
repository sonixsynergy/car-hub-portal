...
echo "<script type='text/javascript'> document.location = 'my-booking003.php'; </script>";
}
else 
{
echo "<script>alert('Something went wrong. Please try again');</script>";
 ...
 echo "<script type='text/javascript'> document.location = 'car_decor.php'; </script>";
}
...
<title>Car Hub | Vehicle Details</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <div class="form-group">
                <input<center><br><br>
    <button class="book-now" type="submit" class="btn"  name="submit" value="Book Now">Book Now</button>
</center>
              </div>
              <?php } else { ?>
