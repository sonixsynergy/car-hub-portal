...
body {
    background-image: url('/CRP/CRP/carrental/admin/img/kalol.jpg'); /* Adjust the path */
    background-size: 100% 100%; /* Ensures full coverage at 100% zoom */
    background-position: center;
    background-repeat: no-repeat;
    background-attachment: fixed; /* Keeps the background stable when scrolling */
  ...
  <div class="container">
    <div class="page-header_wrap">
      ...
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li><a href="kalol.php">About KALOL City</a></li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
